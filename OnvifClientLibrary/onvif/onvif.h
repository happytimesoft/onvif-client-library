...
typedef struct
{
    ...
    void          * curProfile_mutex;                   // current profile pointer mutex
...
HT_API void                                     onvif_curprofile_init_mutex(ONVIF_DEVICE * p_dev);
HT_API void                                     onvif_curprofile_lock(ONVIF_DEVICE * p_dev);
HT_API void                                     onvif_curprofile_unlock(ONVIF_DEVICE * p_dev);

HT_API UserList *                               onvif_add_User(UserList ** p_head);
HT_API UserList *                               onvif_find_User(UserList * p_head, const char * name);
HT_API void                                     onvif_free_Users(UserList ** p_head);

HT_API LocationEntityList *                     onvif_add_LocationEntity(LocationEntityList ** p_head);
HT_API LocationEntityList *                     onvif_find_LocationEntity(LocationEntityList * p_head, const char * token);
HT_API void                                     onvif_free_LocationEntities(LocationEntityList ** p_head);
...
HT_API VideoSourceModeList *                    onvif_find_VideoSourceMode(VideoSourceModeList * p_head, const char * token);
...
HT_API Dot11AvailableNetworksList *             onvif_find_Dot11AvailableNetworks(Dot11AvailableNetworksList * p_head, const char * token);
...
HT_API const char *                             onvif_format_SimpleItem(SimpleItemList * p_item, char * buff, size_t buff_len);
...
HT_API PTZPresetList *                          onvif_find_PTZPreset(PTZPresetList * p_head, const char * token);
...
HT_API void                                     onvif_free_ConfigDescription(ConfigDescriptionList * p_node);
...
HT_API void                                     onvif_free_ConfigOption(ConfigOptionsList * p_node);
...
HT_API void                                     onvif_free_MetadataInfo(MetadataInfoList * p_node);
HT_API void                                     onvif_free_MetadataInfos(MetadataInfoList ** p_head);

HT_API BOOL                                     onvif_base64Binary_init(onvif_base64Binary * data, int size);
HT_API void                                     onvif_base64Binary_free(onvif_base64Binary * data);
...
HT_API void                                     onvif_free_Recording(RecordingList * p_node);
...
HT_API RelayOutputOptionsList *                 onvif_find_RelayOutputOptions(RelayOutputOptionsList * p_head, const char * token);
...
HT_API ThermalConfigurationList *               onvif_find_ThermalConfiguration(ThermalConfigurationList * p_head, const char * token);
...
HT_API void                                     onvif_free_AlgorithmIdentifier(onvif_AlgorithmIdentifier * p_algo);
HT_API void                                     onvif_free_X509Certificate(onvif_X509Certificate * p_cert);
