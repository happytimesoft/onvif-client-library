...
BOOL parse_SecurityService(XMLN * p_node, onvif_SecurityCapabilities * p_res);
BOOL parse_tas_GetServiceCapabilities(XMLN * p_node, tas_GetServiceCapabilities_RES * p_res);
BOOL parse_tas_UploadPassphrase(XMLN * p_node, tas_UploadPassphrase_RES * p_res);
BOOL parse_tas_GetAllPassphrases(XMLN * p_node, tas_GetAllPassphrases_RES * p_res);
BOOL parse_tas_CreateRSAKeyPair(XMLN * p_node, tas_CreateRSAKeyPair_RES * p_res);
BOOL parse_tas_CreateECCKeyPair(XMLN * p_node, tas_CreateECCKeyPair_RES * p_res);
BOOL parse_tas_UploadKeyPairInPKCS8(XMLN * p_node, tas_UploadKeyPairInPKCS8_RES * p_res);
BOOL parse_tas_GetKeyStatus(XMLN * p_node, tas_GetKeyStatus_RES * p_res);
BOOL parse_tas_GetPrivateKeyStatus(XMLN * p_node, tas_GetPrivateKeyStatus_RES * p_res);
BOOL parse_tas_GetAllKeys(XMLN * p_node, tas_GetAllKeys_RES * p_res);
BOOL parse_tas_CreatePKCS10CSR(XMLN * p_node, tas_CreatePKCS10CSR_RES * p_res);
BOOL parse_tas_CreateSelfSignedCertificate(XMLN * p_node, tas_CreateSelfSignedCertificate_RES * p_res);
BOOL parse_tas_UploadCertificate(XMLN * p_node, tas_UploadCertificate_RES * p_res);
BOOL parse_tas_UploadCertificateWithPrivateKeyInPKCS12(XMLN * p_node, tas_UploadCertificateWithPrivateKeyInPKCS12_RES * p_res);
BOOL parse_tas_GetCertificate(XMLN * p_node, tas_GetCertificate_RES * p_res);
BOOL parse_tas_GetAllCertificates(XMLN * p_node, tas_GetAllCertificates_RES * p_res);
BOOL parse_tas_CreateCertificationPath(XMLN * p_node, tas_CreateCertificationPath_RES * p_res);
BOOL parse_tas_GetCertificationPath(XMLN * p_node, tas_GetCertificationPath_RES * p_res);
BOOL parse_tas_GetAllCertificationPaths(XMLN * p_node, tas_GetAllCertificationPaths_RES * p_res);
BOOL parse_tas_CreateCertPathValidationPolicy(XMLN * p_node, tas_CreateCertPathValidationPolicy_RES * p_res);
BOOL parse_tas_GetCertPathValidationPolicy(XMLN * p_node, tas_GetCertPathValidationPolicy_RES * p_res);
BOOL parse_tas_GetAllCertPathValidationPolicies(XMLN * p_node, tas_GetAllCertPathValidationPolicies_RES * p_res);
BOOL parse_tas_GetAssignedServerCertificates(XMLN * p_node, tas_GetAssignedServerCertificates_RES * p_res);
BOOL parse_tas_GetClientAuthenticationRequired(XMLN * p_node, tas_GetClientAuthenticationRequired_RES * p_res);
BOOL parse_tas_GetCnMapsToUser(XMLN * p_node, tas_GetCnMapsToUser_RES * p_res);
BOOL parse_tas_GetAssignedCertPathValidationPolicies(XMLN * p_node, tas_GetAssignedCertPathValidationPolicies_RES * p_res);
BOOL parse_tas_GetEnabledTLSVersions(XMLN * p_node, tas_GetEnabledTLSVersions_RES * p_res);
