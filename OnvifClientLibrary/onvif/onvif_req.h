...
{
    int     dummy;
} tas_GetServiceCapabilities_REQ;
...
{
    int     dummy;
} tas_GetAllPassphrases_REQ;

typedef struct 
{
    char    PassphraseID[ONVIF_TOKEN_LEN];              // required, The ID of the passphrase that is to be deleted from the keystore
...
typedef struct 
{
    ...
    int     KeyLength;                                  // required, The length of the key to be created.
    char    Alias[64];                                  // optional, The client-defined alias of the key
...
typedef struct 
{
    ...
    char    EllipticCurve[64];                          // required, The name of the elliptic curve to be used for generating the ECC keypair. 
...
typedef struct 
{
    ...
    char    Alias[64];                                  // optional, The client-defined alias of the key pair
...
typedef struct 
{
    char    KeyID[ONVIF_TOKEN_LEN];                     // required, The ID of the key for which to return the status
} tas_GetKeyStatus_REQ;

typedef struct 
{
    char    KeyID[ONVIF_TOKEN_LEN];                     // required, The ID of the key pair for which to return whether it contains a private key
...
typedef struct 
{
    char    KeyID[ONVIF_TOKEN_LEN];                     // required, The ID of the key that is to be deleted from the keystore
} tas_DeleteKey_REQ;

typedef struct 
{
    onvif_DistinguishedName Subject;                    // required, The subject to be included in the CSR
    char    KeyID[ONVIF_TOKEN_LEN];                     // required, The ID of the key for which the CSR shall be created
...
{
    int     dummy;
} tas_GetAllCertificationPaths_REQ;
...
{
    int     dummy;
} tas_GetAllCertPathValidationPolicies_REQ;
...
{
    int     dummy;
} tas_GetAssignedServerCertificates_REQ;
...
{
    int     dummy;
} tas_GetClientAuthenticationRequired_REQ;
...
{
    int     dummy;
} tas_GetAssignedCertPathValidationPolicies_REQ;
