 ...
 *
 **/
HT_API BOOL onvif_tas_GetServiceCapabilities(ONVIF_DEVICE * p_dev, tas_GetServiceCapabilities_REQ * p_req, tas_GetServiceCapabilities_RES * p_res);
 ...
 **/
HT_API BOOL onvif_tas_UploadPassphrase(ONVIF_DEVICE * p_dev, tas_UploadPassphrase_REQ * p_req, tas_UploadPassphrase_RES * p_res);

/**
 * @brief
 *  Returns information about all passphrases that are stored in the keystore of the device.
 *
 ...
 *
 **/
HT_API BOOL onvif_tas_GetAllPassphrases(ONVIF_DEVICE * p_dev, tas_GetAllPassphrases_REQ * p_req, tas_GetAllPassphrases_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_DeletePassphrase(ONVIF_DEVICE * p_dev, tas_DeletePassphrase_REQ * p_req, tas_DeletePassphrase_RES * p_res);

/**
 * @brief
 *  Triggers the asynchronous generation of an RSA key pair of a particular keylength (specified as
 ...
 *
 **/
HT_API BOOL onvif_tas_CreateRSAKeyPair(ONVIF_DEVICE * p_dev, tas_CreateRSAKeyPair_REQ * p_req, tas_CreateRSAKeyPair_RES * p_res);
 ...
 *  may also subscribe to Key Status events to be notified about key status changes.
 *
 *  The device also returns a best-effort estimate of how much time it requires to create the key pair.2 A client
 *  may use this information as an indication how long to wait before querying the device whether key generation
 *  is completed.
 *
 *  After the key has been successfully created, the device shall assign it the ok status. If the key generation fails,
 ...
 *
 **/
HT_API BOOL onvif_tas_CreateECCKeyPair(ONVIF_DEVICE * p_dev, tas_CreateECCKeyPair_REQ * p_req, tas_CreateECCKeyPair_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_UploadKeyPairInPKCS8(ONVIF_DEVICE * p_dev, tas_UploadKeyPairInPKCS8_REQ * p_req, tas_UploadKeyPairInPKCS8_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_GetKeyStatus(ONVIF_DEVICE * p_dev, tas_GetKeyStatus_REQ * p_req, tas_GetKeyStatus_RES * p_res);
 ...
 *  otherwise.
 *
 *  This command is deprecated. Use GetAllKeys instead.
 *
 **/
HT_API BOOL onvif_tas_GetPrivateKeyStatus(ONVIF_DEVICE * p_dev, tas_GetPrivateKeyStatus_REQ * p_req, tas_GetPrivateKeyStatus_RES * p_res);

/**
 * @brief
 *  Returns information about all keys that are stored in the device's keystore.
 *
 ...
 *
 **/
HT_API BOOL onvif_tas_GetAllKeys(ONVIF_DEVICE * p_dev, tas_GetAllKeys_REQ * p_req, tas_GetAllKeys_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_DeleteKey(ONVIF_DEVICE * p_dev, tas_DeleteKey_REQ * p_req, tas_DeleteKey_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_CreatePKCS10CSR(ONVIF_DEVICE * p_dev, tas_CreatePKCS10CSR_REQ * p_req, tas_CreatePKCS10CSR_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_CreateSelfSignedCertificate(ONVIF_DEVICE * p_dev, tas_CreateSelfSignedCertificate_REQ * p_req, tas_CreateSelfSignedCertificate_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_UploadCertificate(ONVIF_DEVICE * p_dev, tas_UploadCertificate_REQ * p_req, tas_UploadCertificate_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_UploadCertificateWithPrivateKeyInPKCS12(ONVIF_DEVICE * p_dev, tas_UploadCertificateWithPrivateKeyInPKCS12_REQ * p_req, tas_UploadCertificateWithPrivateKeyInPKCS12_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_GetCertificate(ONVIF_DEVICE * p_dev, tas_GetCertificate_REQ * p_req, tas_GetCertificate_RES * p_res);

/**
 * @brief
 *  Returns all certificates that are stored in the device's keystore.
 *
 ...
 *
 **/
HT_API BOOL onvif_tas_GetAllCertificates(ONVIF_DEVICE * p_dev, tas_GetAllCertificates_REQ * p_req, tas_GetAllCertificates_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_DeleteCertificate(ONVIF_DEVICE * p_dev, tas_DeleteCertificate_REQ * p_req, tas_DeleteCertificate_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_CreateCertificationPath(ONVIF_DEVICE * p_dev, tas_CreateCertificationPath_REQ * p_req, tas_CreateCertificationPath_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_GetCertificationPath(ONVIF_DEVICE * p_dev, tas_GetCertificationPath_REQ * p_req, tas_GetCertificationPath_RES * p_res);

/**
 * @brief
 *  Returns the IDs of all certification paths that are stored in the device's keystore.
 *
 *  This operation may be used, e.g., if a client lost track of which certificates are present on the device.
 *  If no certification path is stored on the device, an empty list is returned.
 *
 **/
HT_API BOOL onvif_tas_GetAllCertificationPaths(ONVIF_DEVICE * p_dev, tas_GetAllCertificationPaths_REQ * p_req, tas_GetAllCertificationPaths_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_SetCertificationPath(ONVIF_DEVICE * p_dev, tas_SetCertificationPath_REQ * p_req, tas_SetCertificationPath_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_DeleteCertificationPath(ONVIF_DEVICE * p_dev, tas_DeleteCertificationPath_REQ * p_req, tas_DeleteCertificationPath_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_CreateCertPathValidationPolicy(ONVIF_DEVICE * p_dev, tas_CreateCertPathValidationPolicy_REQ * p_req, tas_CreateCertPathValidationPolicy_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_GetCertPathValidationPolicy(ONVIF_DEVICE * p_dev, tas_GetCertPathValidationPolicy_REQ * p_req, tas_GetCertPathValidationPolicy_RES * p_res);

/**
 * @brief
 *  Returns all certification path validation policies that are stored in the keystore on the device.
 *
 *  If no certification path validation policy is stored in the device's keystore, an empty list is returned.
 *
 **/
HT_API BOOL onvif_tas_GetAllCertPathValidationPolicies(ONVIF_DEVICE * p_dev, tas_GetAllCertPathValidationPolicies_REQ * p_req, tas_GetAllCertPathValidationPolicies_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_SetCertPathValidationPolicy(ONVIF_DEVICE * p_dev, tas_SetCertPathValidationPolicy_REQ * p_req, tas_SetCertPathValidationPolicy_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_DeleteCertPathValidationPolicy(ONVIF_DEVICE * p_dev, tas_DeleteCertPathValidationPolicy_REQ * p_req, tas_DeleteCertPathValidationPolicy_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_AddServerCertificateAssignment(ONVIF_DEVICE * p_dev, tas_AddServerCertificateAssignment_REQ * p_req, tas_AddServerCertificateAssignment_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_RemoveServerCertificateAssignment(ONVIF_DEVICE * p_dev, tas_RemoveServerCertificateAssignment_REQ * p_req, tas_RemoveServerCertificateAssignment_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_ReplaceServerCertificateAssignment(ONVIF_DEVICE * p_dev, tas_ReplaceServerCertificateAssignment_REQ * p_req, tas_ReplaceServerCertificateAssignment_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_GetAssignedServerCertificates(ONVIF_DEVICE * p_dev, tas_GetAssignedServerCertificates_REQ * p_req, tas_GetAssignedServerCertificates_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_SetClientAuthenticationRequired(ONVIF_DEVICE * p_dev, tas_SetClientAuthenticationRequired_REQ * p_req, tas_SetClientAuthenticationRequired_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_GetClientAuthenticationRequired(ONVIF_DEVICE * p_dev, tas_GetClientAuthenticationRequired_REQ * p_req, tas_GetClientAuthenticationRequired_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_SetCnMapsToUser(ONVIF_DEVICE * p_dev, tas_SetCnMapsToUser_REQ * p_req, tas_SetCnMapsToUser_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_GetCnMapsToUser(ONVIF_DEVICE * p_dev, tas_GetCnMapsToUser_REQ * p_req, tas_GetCnMapsToUser_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_AddCertPathValidationPolicyAssignment(ONVIF_DEVICE * p_dev, tas_AddCertPathValidationPolicyAssignment_REQ * p_req, tas_AddCertPathValidationPolicyAssignment_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_RemoveCertPathValidationPolicyAssignment(ONVIF_DEVICE * p_dev, tas_RemoveCertPathValidationPolicyAssignment_REQ * p_req, tas_RemoveCertPathValidationPolicyAssignment_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_ReplaceCertPathValidationPolicyAssignment(ONVIF_DEVICE * p_dev, tas_ReplaceCertPathValidationPolicyAssignment_REQ * p_req, tas_ReplaceCertPathValidationPolicyAssignment_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_GetAssignedCertPathValidationPolicies(ONVIF_DEVICE * p_dev, tas_GetAssignedCertPathValidationPolicies_REQ * p_req, tas_GetAssignedCertPathValidationPolicies_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_SetEnabledTLSVersions(ONVIF_DEVICE * p_dev, tas_SetEnabledTLSVersions_REQ * p_req, tas_SetEnabledTLSVersions_RES * p_res);
 ...
 *
 **/
HT_API BOOL onvif_tas_GetEnabledTLSVersions(ONVIF_DEVICE * p_dev, tas_GetEnabledTLSVersions_REQ * p_req, tas_GetEnabledTLSVersions_RES * p_res);
