...
typedef enum 
{
    ...
    etasGetAllPassphrases,
    etasDeletePassphrase,
    etasCreateRSAKeyPair,
    etasCreateECCKeyPair,
    etasUploadKeyPairInPKCS8,
    etasGetKeyStatus,
    etasGetPrivateKeyStatus,
    etasGetAllKeys,
    etasDeleteKey,
    etasCreatePKCS10CSR,
    etasCreateSelfSignedCertificate,
    etasUploadCertificate,
    etasUploadCertificateWithPrivateKeyInPKCS12,
    etasGetCertificate,
    etasGetAllCertificates,
    etasDeleteCertificate,
    etasCreateCertificationPath,
    etasGetCertificationPath,
    etasGetAllCertificationPaths,
    etasSetCertificationPath,
    etasDeleteCertificationPath,
    etasCreateCertPathValidationPolicy,
    etasGetCertPathValidationPolicy,
    etasGetAllCertPathValidationPolicies,
    etasSetCertPathValidationPolicy,
    etasDeleteCertPathValidationPolicy,
    etasAddServerCertificateAssignment,
    etasRemoveServerCertificateAssignment,
    etasReplaceServerCertificateAssignment,
    etasGetAssignedServerCertificates,
    etasSetClientAuthenticationRequired,
    etasGetClientAuthenticationRequired,
    etasSetCnMapsToUser,
    etasGetCnMapsToUser,
    etasAddCertPathValidationPolicyAssignment,
    etasRemoveCertPathValidationPolicyAssignment,
    etasReplaceCertPathValidationPolicyAssignment,
