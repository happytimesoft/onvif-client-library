...
typedef struct 
{
    onvif_SecurityCapabilities  Capabilities;           // required, The capabilities for the security configuration service is returned in the Capabilities element
} tas_GetServiceCapabilities_RES;

typedef struct 
{
    char    PassphraseID[ONVIF_TOKEN_LEN];              // required, The PassphraseID of the uploaded passphrase
...
{
    int     dummy;
} tas_DeletePassphrase_RES;

typedef struct 
{
    char    KeyID[ONVIF_TOKEN_LEN];                     // required, The key ID of the key pair being generated
    uint32  EstimatedCreationTime;                      // required, Best-effort estimate of how long the key generation will take
...
typedef struct 
{
    char    KeyID[ONVIF_TOKEN_LEN];                     // required, The key ID of the uploaded key pair
} tas_UploadKeyPairInPKCS8_RES;

typedef struct 
{
     char   KeyStatus[32];                              // required, Status of the requested key. The value should be one of the values in the tas:KeyStatus enumeration
                                                        //  ok, generating, corrupt
...
{
    int     dummy;
} tas_SetCertificationPath_RES;

typedef struct 
{
    int     dummy;
} tas_DeleteCertificationPath_RES;
...
{
    int     dummy;
} tas_SetCertPathValidationPolicy_RES;

typedef struct 
{
    int     dummy;
} tas_DeleteCertPathValidationPolicy_RES;

typedef struct 
{
    int     dummy;
} tas_AddServerCertificateAssignment_RES;

typedef struct 
{
    int     dummy;
} tas_RemoveServerCertificateAssignment_RES;

typedef struct 
{
    int     dummy;
} tas_ReplaceServerCertificateAssignment_RES;
...
{
    int     dummy;
} tas_SetClientAuthenticationRequired_RES;
...
{
    int     dummy;
} tas_AddCertPathValidationPolicyAssignment_RES;

typedef struct 
{
    int     dummy;
} tas_RemoveCertPathValidationPolicyAssignment_RES;

typedef struct 
{
    int     dummy;
} tas_ReplaceCertPathValidationPolicyAssignment_RES;
