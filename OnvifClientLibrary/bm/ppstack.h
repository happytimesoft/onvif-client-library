...
HT_API PPSN_CTX   * pps_fl_init(uint32 node_num, uint32 content_size, BOOL need_mutex);
...
HT_API void         pps_fl_show(PPSN_CTX * pps_ctx);

HT_API PPSN_CTX   * pps_ul_init(PPSN_CTX * fl_ctx, BOOL need_mutex);
HT_API BOOL         pps_ul_init_assign(PPSN_CTX * ul_ctx, PPSN_CTX * fl_ctx, BOOL need_mutex);
HT_API BOOL         pps_ul_init_nm(PPSN_CTX * fl_ctx, PPSN_CTX * ul_ctx);
HT_API void         pps_ul_free(PPSN_CTX * ul_ctx);

HT_API BOOL         pps_ul_del(PPSN_CTX * ul_ctx, void * content_ptr);
HT_API PPSN       * pps_ul_del_node_nolock(PPSN_CTX * ul_ctx, PPSN * p_node);
HT_API void       * pps_ul_del_nolock(PPSN_CTX * ul_ctx, void * content_ptr);

HT_API BOOL         pps_ul_add(PPSN_CTX * ul_ctx, void * content_ptr);
HT_API BOOL         pps_ul_add_head(PPSN_CTX * ul_ctx, void * content_ptr);
HT_API void       * pps_ul_pop_head(PPSN_CTX * ul_ctx);
...
HT_API void         pps_lock(PPSN_CTX * pps_ctx);
HT_API void         pps_unlock(PPSN_CTX * pps_ctx);
...
/***************************************************************************************/
HT_API uint32       pps_node_count(PPSN_CTX * pps_ctx);
